...
class Bd {
	...
	getProximoId(){
		let proximoId = JSON.parse(localStorage.getItem('id'))
		return proximoId + 1
	}
...
function cadastrarDespesa(){
	...
	if(despesa.validarDados()) {
		...
		document.getElementById('modal_corpo').innerHTML = 'Despesa cadastrada com sucesso.'
		document.getElementById('modal_botao').innerHTML = 'Cadastrar novo item'
